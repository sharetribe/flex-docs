...
const CarouselTransactionProcessComponents = props => {
  return (
    <Carousel {...props} maxWidth="480px">
      <Slide imgSrc={IMG_TRANSACTION_PROCESS_COMPONENTS} imgAlt="Transaction process components">
      </Slide>
      ...
      <Slide imgSrc={IMG_TRANSACTION_ACTIONS} imgAlt="Transaction actions">
        ...
        <p>
          Actions define what happens during a transition. For instance, a transaction transitioning to the cancelled state in the default process involves three actions: <b>cancel</b> the booking reservation, <b>calculate</b> the full refund amount and <b>trigger</b> the refund payment in full. 
        </p>
      </Slide>
      <Slide imgSrc={IMG_TRANSACTION_NOTIFICATIONS} imgAlt="Transaction notifications">
