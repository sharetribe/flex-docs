...
[The Sharetribe Web Template](https://www.sharetribe.com/docs/operator-guides/concepts/#sharetribe-web-template)
...
[Getting started with the web template](/introduction/getting-started-with-web-template/)
tutorial.
