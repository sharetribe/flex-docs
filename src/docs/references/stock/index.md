...
your [transaction process](/concepts-transaction-process/transaction-process/). An
...
[transaction transition](/concepts-transaction-process/transaction-process/) failed to
